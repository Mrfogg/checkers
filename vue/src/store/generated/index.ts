...
import MrfoggCheckersMrfoggCheckersCheckers from './Mrfogg/checkers/mrfogg.checkers.checkers'
...
export default { 
  MrfoggCheckersMrfoggCheckersCheckers: load(MrfoggCheckersMrfoggCheckersCheckers, 'mrfogg.checkers.checkers'),
